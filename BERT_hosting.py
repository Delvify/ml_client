...
bert_path = '/home/jugs/Desktop/BERT-Pretrained/uncased_L-12_H-768_A-12/1/'

flags.DEFINE_string(
    "bert_config_file" , os.path.join(bert_path, 'bert_config.json'),
    "The config json file corresponding to the pre-training BERT model"
)
...
flags.DEFINE_string(
    ...
    "Initial checkpoint (usually from a pre-training BERT model)"
)
...
ber_config = modeling.BertConfig.from_json_file(FLAGS.bert_config_file)
